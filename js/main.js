...
(function () {
  ...
  // Playlist - can be set by pages or restored from storage
  ...
  function restoreState() {
    try {
      ...
      if (state && typeof state.track === "number" && playlist[state.track]) {
        ...
        // No valid state — load first track but don't autoplay
        loadTrack(0, false);
      }
    } catch (e) {
